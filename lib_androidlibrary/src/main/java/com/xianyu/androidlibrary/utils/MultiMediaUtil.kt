...
//    }
//
//    private fun pohotoSelect(activity: FragmentActivity?, fragment: Fragment?, count: Int, requestcode: Int) {
...
//    }
//
//    private fun takePhoto(activity: FragmentActivity?, fragment: Fragment?, path: String, requestcode: Int) {
...
//    }
//
//    private fun takeVideo(activity: FragmentActivity?, fragment: Fragment?, path: String, requestcode: Int) {
//        if (activity == null && fragment == null) {
//            return
//        }
//        var rxPermissions: RxPermissions? = null
