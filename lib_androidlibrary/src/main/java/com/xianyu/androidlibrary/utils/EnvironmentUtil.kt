...
class EnvironmentUtil {
    ...
    fun isAppRunning(context: Context): Boolean {
        ...
        val runningTaskInfo = activityManager.getRunningTasks(100) ?: return false
        for (taskInfo in runningTaskInfo)
    ...
    protected fun isTopActivity(context: Context, clazz: Class<*>): Boolean {
        ...
        return (runningTaskInfo != null && runningTaskInfo.isNotEmpty()
                && clazz.name == runningTaskInfo[0].topActivity!!.className)
    }
