...
import com.xianyu.net.cache.CacheManager;
        ...
        if (mCacheStrategy != CACHE_ONLY) {
            getCall().enqueue(new Callback() {
                ...
                public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                    Log.i("cxy", "testCache: response2 :"+response.body().string());
                    Log.i("cxy", "testCache: response2 cache :"+response.cacheResponse());
                    Log.i("cxy", "testCache: response2 network :"+response.networkResponse());
